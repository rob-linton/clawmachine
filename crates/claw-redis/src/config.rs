...
fn defaults() -> HashMap<&'static str, &'static str> {
    ...
    m.insert(
        ...
        r#"[{"host_path":"~/.claude","container_path":"/home/claw/.claude","readonly":false},{"host_path":"~/.config/gh","container_path":"/home/claw/.config/gh","readonly":true},{"host_path":"~/.ssh","container_path":"/home/claw/.ssh","readonly":true}]"#,
    );
    m
}
